...
print(no_label_genome_size_density_plot)
dev.off()

pdf("Contig number plot.pdf")
print(no_label_contig_number_density_plot)
dev.off()

pdf("N50 plot.pdf")
print(no_label_N50_density_plot)
dev.off()

pdf("Completeness plot.pdf")
print(no_label_completeness_density_plot)
dev.off()

pdf("Contamination plot.pdf")
print(no_label_contamination_density_plot)
dev.off()

pdf("Strain heterogeneity.pdf")
print(no_label_strain_heterogeneity_density_plot)
dev.off()
